...
export default function MyPageScreen({ onBack }: MyPageScreenProps) {
  ...
  if (showIdentityComplete) {
    return <IdentityVerificationCompleteScreen onBack={goBack} />
  }
  ...
  if (showPointHistory) {
    return <PointHistoryScreen onBack={goBack} />
  }

  if (showPaymentInfo) {
    return <PaymentInfoScreen onBack={goBack} />
  }
  ...
  if (showJoinedCasts) {
    return <JoinedCastsScreen onBack={goBack} />
  }

  if (showProfileEdit) {
    return <ProfileEditScreen onBack={goBack} />
  }
