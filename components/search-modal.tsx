        ...
        <div className="flex-1 overflow-y-auto p-4 pb-20">
              ...
              <div className="flex justify-between items-center">
                <div className="text-left">
                  <p className="text-sm text-gray-600 mb-1">
                    スタイル、顔立ち、系統、髪型、職歴、楽しみ方、対応スキルなどキャストの詳細タグから検索できます
                  </p>
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {["プレミアム", "VIP", "ロイヤルVIP", "ハイクラス"].map((className) => (
                <button
                  key={className}
            ...
            <div className="space-y-2 text-xs text-gray-600">
              <p>「プレミアム」… 合格率10%の面談を通過した厳選キャスト</p>
              <p>「VIP」… 厳選キャストの中でも更に10%しかいない特別なキャスト</p>
              <p>「ロイヤルVIP」… キャストの中でも1%しかいない最上級キャスト</p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-xs text-gray-500 mb-3">※2文字以上10文字未満</p>
            <input
              type="text"
