      ...
      <div id="profile-preview-scroll" className="flex-1 overflow-y-auto pb-8 relative z-10">
        ...
        <div className="bg-white p-4">
          <div className="space-y-3">
            ...
            {/* Income */}
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              <span className="text-xs text-gray-600">年収：</span>
              <span className="text-xs font-medium">{basicInfo.income}</span>
            </div>
            ...
            {/* Tobacco */}
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              <span className="text-xs text-gray-600">タバコ：</span>
              <span className="text-xs font-medium">{basicInfo.tobacco}</span>
            </div>
            ...
            <div className="flex justify-between items-center py-2">
              <span className="text-xs text-gray-600">同居人：</span>
              <span className="text-xs font-medium">{basicInfo.cohabitation}</span>
            </div>
          </div>
        </div>
