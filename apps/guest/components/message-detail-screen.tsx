        ...
        <div className="flex items-end gap-2">
          ...
          {messageText.trim() && (
            <button
              ...
              className="w-9 h-9 bg-gold-pink-gradient hover:bg-gold-pink-gradient-dark rounded-full flex items-center justify-center shadow-sm flex-shrink-0 transition-colors"
            >
