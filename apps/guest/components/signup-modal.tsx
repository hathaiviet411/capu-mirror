      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6">
        <div className="w-full px-4">
          <p className="text-gray-700 text-center mb-8 text-sm leading-relaxed">
            18歳以上なので
            <a href="https://capu-app.notion.site/Capu_-21b42cc81529808d8bbcfab37ec4c2ef" target="_blank" rel="noopener noreferrer" className="underline text-pink-600">利用規約</a>と
            <a href="https://capu-app.notion.site/Capu_-21b42cc815298053b8f6e818e327c1f1" target="_blank" rel="noopener noreferrer" className="underline text-pink-600">プライバシーポリシー</a>に同意して、
          </p>
