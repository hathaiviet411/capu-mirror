...
export default function MyPageScreen({ onBack }: MyPageScreenProps) {
  ...
  if (showPaymentInfo) {
    return <AccountSettingsScreen onBack={backToMyPageMain} />
  }
      ...
      <div className="flex-1 overflow-y-auto pt-[64px] bg-gray-100 content-with-safe-footer">
        ...
        <div className="bg-white p-8 text-center">
          <div className="relative inline-block mb-4">
            ...
            <button
              onClick={navigateToProfileEdit}
              className="absolute bottom-2 right-2 w-8 h-8 bg-main-navy-gradient rounded-full flex items-center justify-center shadow-lg"
            >
        ...
        <div className="bg-white">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-black">口座設定</span>
            </div>
            <ChevronRight className="w-5 h-5 text-gray-400" />
          </button>
