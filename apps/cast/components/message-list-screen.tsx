...
export default function MessageListScreen({ onBack, onNavigateToMyPage, onNavigateToHome }: MessageListScreenProps) {
  ...
  const messages = [
    ...
    },
    {
      ...
      guestName: "ゆきの🌸",
      guestAge: 23,
      lastMessage: "お疲れさまです！今日もお仕事頑張ってください😊",
      timestamp: "昨日",
      unreadCount: 1,
    ...
    },
    {
      ...
      guestName: "りか☕東京",
      guestAge: 25,
      lastMessage: "今度一緒にカフェでお話しできればと思います☕",
    ...
    },
    {
      ...
      guestName: "あやか🍷",
      guestAge: 28,
      lastMessage: "今度お酒を飲みながらお話ししませんか？🍷",
                  ...
                  <div className="flex items-start justify-between mb-1">
                    <div className="flex items-center gap-2">
                      <h3 className="text-sm font-medium text-black truncate">
                        {message.guestName} {message.guestAge}歳
                      </h3>
                      {/* Pin Icon */}
                      {message.isPinned && (
